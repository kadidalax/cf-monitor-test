...
const rpc = readFileSync('supabase/migrations/4_rpc_api.sql', 'utf8');
...
const checks = [
  ...
  [generated.includes('"version": "4_rpc_api"'), 'generated migrations must include website reorder order fix'],
