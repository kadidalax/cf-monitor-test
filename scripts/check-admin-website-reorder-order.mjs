...
const rpc = readFileSync('supabase/migrations/20260701174548_fix_website_reorder_order.sql', 'utf8');
...
const rpcStart = rpc.indexOf('create or replace function public.cfm_reorder_website_monitors');
const rpcEnd = rpc.indexOf('create or replace function public.cfm_set_website_monitor_visibility');
...
const checks = [
  ...
  [generated.includes('"version": "20260701174548_fix_website_reorder_order"'), 'generated migrations must include website reorder order fix'],
